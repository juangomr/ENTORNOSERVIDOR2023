...
<body>
    ...
    if ($paginaActual == 1) {
        ...
        ?>
        <div class="centrar">
            <button onclick="window.location.href='indexSesionIniciadaUsuario.php?pagina=<?php echo $paginaSiguiente ?>'"
    ...
    if ($paginaActual > 1 && $paginaActual <= $num_paginas_total) {
        ...
        if ($paginaSiguiente) {
            ...
            ?>
            <div class="centrar">
                <button onclick="window.location.href='indexSesionIniciadaUsuario.php?pagina=<?php echo $paginaAnterior ?>'"
